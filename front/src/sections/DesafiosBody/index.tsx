...
import { ChallengesContainer, ChallengesSubTitle, ChallengesTitle, DesafiosBodyContainer, DesafiosBodyPrincipalContainer, MenuContainer, MenuText, PreDivisionText, Paragraph, ConteudoDesafiosContainer, Titulo_info } from "./style";

const desafios_menu = ["Título de um desafio", 
        ...
        <>
            ...
            <DesafiosBodyContainer>
                <PreDivisionText>
                    ...
                    Explore, escolha o que mais te motiva e venha construir soluções com a gente. 
                ...
                <DesafiosBodyPrincipalContainer>
                    <MenuContainer>
                        {desafios_menu.map((desafio, index) => (
                            <MenuText key={index} className={activeIndex === index ? "active" : ""}>
